...
import { Menu, User, Home, Info, Package, Star, Mail, Settings, LogOut, Shield } from "lucide-react"
...
const navItems: NavItem[] = [
  { href: "/mersifvista#hero", label: "Home", icon: Home },
  { href: "/mersifvista#impact", label: "Impact", icon: Info },
  { href: "/mersifvista#pillar", label: "Pillar", icon: Star },
  { href: "/mersifvista#contact", label: "Contact", icon: Mail },
]
          ...
          <nav className="hidden md:flex items-center justify-center flex-1 max-w-4xl">
            <div className="bg-white/90 backdrop-blur-sm border border-gray-200/50 rounded-2xl shadow-lg shadow-gray-200/20 px-4 py-3">
              <div className="flex items-center space-x-1">
                {/* Small Logo in Navbar - MUCH BIGGER NOW */}
                <div className="flex items-center mr-4">
                  <Link href="/mersifvista" className="flex items-center">
                    <Image
                      src="/img/navbar-logo/logoVISTA.svg"
                      alt="VISTA Logo"
                      width={180}
                      height={55}
                      className="h-11 w-auto opacity-90 hover:opacity-100 transition-opacity duration-200"
                      onError={(e) => {
                        console.error('Failed to load logoVISTA.svg, trying logoVISTA.png...');
                        e.currentTarget.src = '/img/navbar-logo/logoVISTA.png';
                      }}
                    />
                  </Link>
